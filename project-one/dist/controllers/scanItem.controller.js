...
exports.getScanItems = exports.createScanItem = void 0;
const client_1 = require("@prisma/client");
const socket_1 = require("../socket");
const prisma = new client_1.PrismaClient();
const createScanItem = async (req, res) => {
...
exports.createScanItem = createScanItem;
const getScanItems = async (req, res) => {
    const userId = req.session.userId;
    if (!userId) {
        return res.status(401).json({ error: 'User not authenticated' });
    }
...
exports.getScanItems = getScanItems;
